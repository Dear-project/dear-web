...
const PersonalInformation = () => {
  ...
  return (
    <>
      <InformationContainer>
        <InformationHeadBox>
        <Link  to="https://dear.jeonguji.com/">
          <InformationLogo
            src={Logo}
            alt="logo"
          />
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            Dear는 수집한 개인정보를 다음의 목적을 위해 활용하며 다른 용도로는
            사용 되지 않습니다. 차후 이용목적이 변경될 시에는 사전에 동의를
            구합니다. 이메일, 비밀번호: 서비스 이용에 따른 본인 식별, 중복가입
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            Dear는 회원가입일로부터 서비스를 제공하는 기간 동안에 한하여
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            Dear는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다.
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            ...
            귀속됩니다.
            <br />
            ② 다음 각 호에 해당하는 범위 내에서 Dear는 회원이 등록한 게시물을
            ...
            <br />
            ③ Dear는 제2항 이외의 방법으로 회원의 게시물을 이용하고자 하는 경우
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            Dear는 이용자의 개인정보를 취급함에 있어 개인정보가 분실, 도난,
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            ...
            수 있도록 되어 있습니다. Dear는 이용자의 개인적인 부주의로 
        ...
        <InformationContentContainer>
          ...
          <InformationContent>
            ...
            Dear서비스를 이용하며 발생하는 모든 개인정보보호 관련 민원을
