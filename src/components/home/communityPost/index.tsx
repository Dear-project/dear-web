...
const CommunityPost = ({id,title,modifiedDateTime,Description,profileImage,userName,createdDateTime,comment,customStyle}:CommunityPost)=>{
...
return(
    <S.CommunityPost 
        ...
        <S.PostInfo>
            <Image
            src={profileImage ? profileImage : Avartar}
            alt="프로필사진 에러"
            width={30}
            height={30}
            />
